...
export class ColumnWidthsSettingTab extends PluginSettingTab {
	...
	applyStyles() {
		...
		rootStyle.setProperty('--sc-border-width', `${borderWidth}px`);
		rootStyle.setProperty('--sc-border-shown', showBorders ? 'solid' : 'none');
		rootStyle.setProperty('--sc-border-color', showBorders ? finalBorderColor : 'transparent');
		rootStyle.setProperty('--sc-border-radius', `${borderRadius}px`);

		rootStyle.setProperty('--sc-resizer-bg', showResizer ? finalResizerColor : 'transparent');
		rootStyle.setProperty('--sc-resizer-hover-bg', finalResizerColor);
		rootStyle.setProperty('--sc-resizer-width', `${resizerWidth}px`);
	}
